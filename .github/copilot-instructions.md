...
The README states that CI automatically re-renders the SVG & PNG on every push.
...
This file is intentionally short and prescriptive: focus edits on the `.mmd` diagram source, avoid generated assets, and reference local verification steps. The repository includes a GitHub Actions workflow that renders the Mermaid file automatically on push.
